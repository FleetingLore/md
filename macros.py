...
def _schemdraw_svg(project_dir: str, name: str) -> str:
...
def define_env(env):
    ...
    @env.macro
    def sch(name):
        """Render a schemdraw circuit as inline SVG.
        Usage:  {{ sch('examples.two_resistors_series') }}
        """
        try:
            uri = _schemdraw_svg(env.project_dir, name)
